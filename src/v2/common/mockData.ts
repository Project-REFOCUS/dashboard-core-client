...
import { Category, GeoFilterType, Geography } from "./types";
...
export const mockFilterOptions: GeoFilterType[] = [
    { type: GeographyEnum.COUNTY, subTypes: [GeographyEnum.CITY, GeographyEnum.BLOCK_GROUP, GeographyEnum.CENSUS_TRACT] },
    { type: GeographyEnum.CITY, subTypes: [GeographyEnum.ZIPCODE] },
    { type: GeographyEnum.BLOCK_GROUP, subTypes: [GeographyEnum.CENSUS_TRACT, GeographyEnum.ZIPCODE] },
